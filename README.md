...
[Liam Staskawicz's repo on Bitbucket](https://bitbucket.org/liamstask/goose). I'm
just not a fan of BitBucket, so I've forked it here. If you have questions,
concerns, or anything like that, go there. This is really just a fork to change
the SQL template.
...
[![Build Status](https://drone.io/github.com/seanhagen/goose/status.png)](https://drone.io/github.com/seanhagen/goose/latest)

# Install

    $ go get github.com/seanhagen/goose/cmd/goose

This will install the `goose` binary to your `$GOPATH/bin` directory.

You can also build goose into your own applications by importing `github.com/seanhagen/goose/lib/goose`. Documentation is available at [godoc.org](http://godoc.org/github.com/seanhagen/goose/lib/goose).
...
import _ "github.com/seanhagen/goose/cmd/goose"
```
